...
const Banner = () => {
  return (
    <div>
       ...
       <div className="z-10 absolute top-[35%] lg:top-[18%] w-full lg:w-8/12 xl:w-6/12  px-5 md:px-20 flex flex-col gap-y-2 text-white">
        <h1 className="text-2xl md:text-4xl font-semibold">Unleash your inner fashion <br /> rebel</h1>
