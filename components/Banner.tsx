  ...
  return (
    <div className="relative">
       <div className="w-full h-[470px] md:h-[550px] overflow-y-hidden">
            <Image src={Img54} height={850} width={1640} alt="" className="w-full h-full hidden md:flex bg-cover object-cover bg-center brightness-75" />
            <Image src={Img55} height={488} width={720} alt="" className="w-full h-full flex md:hidden bg-cover object-cover bg-center brightness-75" />
       </div>
       <div className="z-10 absolute top-[30%] lg:top-[30%] xl:top-[35%] xxl:top-[30%] w-full lg:w-8/12 xl:w-6/12  px-5 md:px-20 flex flex-col gap-y-2 text-white">
        ...
        <button className="w-2/6 lg:w-3/12 py-2  bg-white text-black">Shop Now</button>
       </div>
    </div>
  )
}
